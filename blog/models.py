...
class Post(models.Model):
    ...
    intro = models.TextField(blank=False, max_length=160)
    keywords = models.TextField(validators=[validate_comma_separated_words])
...
# 100% Working for TranslatableModel
...
#     class Meta:
#         # ordering = self.objects.translated('en').order_by('translations__publish')
#         # ordering = ['-publish']
#         indexes = [
#             models.Index(fields=['-publish']),
#         ]
